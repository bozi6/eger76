...
<div class="form-row">
  ...
  <div class="form-group col-md-4">
    ...
    <input type="text" name="befiz" class="form-control" disabled="disabled" id="karsz" placeholder="<?=lang('Karszalag.karszsz')?>">
  </div>
  <div class="form-group col-md-4">
    <?= form_label(lang('Karszalag.karszGykarsz'),'gykarsz',$labeldata);?>
    <input type="text" name="gybefiz" class="form-control" disabled="disabled" id="gykarsz" placeholder="<?=lang('Karszalag.karszsz')?>">
  </div>
</div>
<div class="form-row">
...
<div class="form-row">
  <div class="form-group col-md-12">
    ...
    <input type="text" name="megjegy" class="form-control" id="megjegy" placeholder="<?=lang('Karszalag.karszMegj');?>">
  </div>
</div>
<div class="form-row">

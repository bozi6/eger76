...
<head>
	...
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url('/vendor/twbs/bootstrap/dist/css/bootstrap.css'); ?>">
	<?php
	if ($nyelv == 'ar') {
	...
	?>
	<link rel="stylesheet" type="text/css"
		  href="<?php echo base_url('/vendor/components/jqueryui/themes/base/jquery-ui.css'); ?>">
	...
	<link rel="stylesheet" media="screen" type="text/css"
		  href="<?php echo base_url('/vendor/mottie/tablesorter/dist/css/theme.metro-dark.min.css'); ?>">
